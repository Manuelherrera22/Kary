...
const MagicBackground = ({ children }) => {
  ...
  return (
    <div className="relative min-h-screen font-poppins text-white overflow-hidden">
      <motion.div 
        ref={constraintsRef}
      ...
      >
        ...
        <motion.div 
          className="absolute top-[-10%] left-[-10%] w-[40vw] h-[40vw] bg-purple-500/20 rounded-full filter blur-3xl opacity-60"
          animate={{ x: [-100, 200, -100], y: [-50, 150, -50], scale: [1, 1.2, 1], rotate: [0, 90, 0] }}
          transition={{ duration: 35, repeat: Infinity, repeatType: 'reverse' }}
        />
        <motion.div 
          className="absolute bottom-[-15%] right-[-15%] w-[35vw] h-[35vw] bg-sky-500/20 rounded-full filter blur-3xl opacity-50"
