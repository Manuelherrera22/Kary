      ...
      <Card className="bg-gradient-to-br from-slate-800/90 to-slate-900/90 border-slate-700/50 text-slate-100 overflow-hidden relative">
        ...
        <CardHeader className="relative pb-6">
          <div className="flex items-center justify-between">
            ...
            <Badge variant="secondary" className="bg-blue-500/20 text-blue-300 border-blue-500/30 text-sm font-medium px-3 py-1">
        ...
        <CardContent className="relative space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-slate-700/30 rounded-lg p-4 border border-slate-600/50 hover:bg-slate-700/50 transition-all duration-200">
          ...
          {/* Achievements */}
          <div className="space-y-4">
            <h4 className="text-base font-semibold text-slate-200 flex items-center gap-3">
              ...
              {achievements.map((achievement) => {
                ...
                return (
                  <Badge 
                    key={achievement.id}
                    variant="secondary" 
                    className={`${achievement.color} bg-slate-700/50 border-slate-600/50 hover:bg-slate-600/50 transition-colors text-sm font-medium px-3 py-1`}
                  >
