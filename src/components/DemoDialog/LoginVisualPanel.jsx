...
const LoginVisualPanel = () => {
  ...
  return (
    <div className="w-full md:w-2/5 bg-gradient-to-br from-purple-700 via-pink-600 to-orange-500 p-3 sm:p-4 md:p-6 lg:p-8 text-white flex flex-col justify-between rounded-t-xl md:rounded-l-xl md:rounded-r-none min-h-[200px] sm:min-h-[250px] md:min-h-[300px] lg:min-h-[400px]">
      <div className="flex-grow flex flex-col justify-center items-center text-center">
        ...
        >
          <img
            ...
            className="h-12 sm:h-16 md:h-20 lg:h-24 xl:h-28 w-auto mb-3 sm:mb-4 md:mb-6 mx-auto filter drop-shadow-lg"
          />
          <DialogTitle className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-2 sm:mb-3 text-shadow-sm px-2">
            {t("demoDialog.title")}
          </DialogTitle>
          <DialogDescription className="text-purple-100 text-sm sm:text-base md:text-lg lg:text-xl mt-2 max-w-xs mx-auto text-shadow-xs px-2 leading-relaxed">
